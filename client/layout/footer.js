              ...
              <Link href="/">
                <a className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  <span>
                    <img
                      src="/brand/logo.png"
                      alt="Kenya Tech Awards"
                      width="32"
                      height="32"
                      className="w-10"
                    />
                  </span>
                  <span>Kenya Tech Awards</span>
                </a>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Kenya Tech Awards offers a unique forum in which academics,
              educators, start-ups, entrepreneurs, policymakers and students
              share their stories with fellow interest groups to quench their
